...
class Api_Posts extends Api_Unit {
	public function __construct(){
		...
		$this->load->model('Mdl_Posts', '', TRUE);
	}
...
########################################################################################################################################################*/
	public function api_entry_list() {
		...
		parent::returnWithoutErr("Request has been listed successfully.", array(
			'page'=>$_POST['page'],
			'total'=>$this->Mdl_Posts->get_length(),
			'rows'=>$data,
		));
	}
	...
	public function api_entry_edit() {
		...
		/*
			Edited successfully .... 
		*/
		parent::returnWithoutErr("Post has been modified successfully.", $request);
	}
